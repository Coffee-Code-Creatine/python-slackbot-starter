...
token = "xoxb-470864710675-3691642836676-vGw6HS1Er9POJEjNqaYZDSQx"
slack_signing_secret = "8261dc056d4024fbfb3f9cbf1a806a73"
...
if __name__ == "__main__":
    app.run(host='0.0.0.0', port=4000, use_reloader=False, threaded=True)